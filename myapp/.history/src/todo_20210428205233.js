...
class DisplayTask extends React.Component{
    ...
    <a href="#" class="list-group-item list-group-item-action " style={{width:600, textAlign:"center"}}>{this.props.content.content} <button className="btn btn-success"><i className="fa fa-check "></i></button>   <button className="btn btn-danger"><i className="fa fa-times btn-danger" ></i></button></a>
