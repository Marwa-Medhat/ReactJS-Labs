...
class DisplayTasks extends React.Component{
    ...
    render(){
            let btn_class = this.props.mark ? "blackButton" : "whiteButton";
        return <div class="list-group ">  
            <div>this.props.contents.map((item,index)=>{
            <div className={" list-group-item list-group-item-action "+btn_class}  >
       <a style={{width:600 ,fontWeight:'bolder',marginRight:50,}}>{this.props.contents} </a>
