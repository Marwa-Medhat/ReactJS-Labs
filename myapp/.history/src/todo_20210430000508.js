        ...
        return <div class="list-group ">          
            {this.props.contents.length > 0 ?this.props.contents.map((item,index)=>{
                return <div style={{display: 'inline-block'}}> 
                    <DisplayTask style={{display: 'inline-block'}} content={item} key={item.content} mark={this.props.mark} markContent={this.props.markContent} deleteContent={this.props.deleteContent} />  
