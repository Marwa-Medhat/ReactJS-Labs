...
class DisplayTask extends React.Component{
    render(){
        return <div>
            ...
            <a onClick={()=> this.props.toggleActive(item,text)} style={{backgroundColor:item.active? "red" :"green"}} class="list-group-item list-group-item-action ">{this.props.content.content}</a><br/>
