...
class DisplayTasks extends React.Component{
    ...
    //   console.log(this.props.contents)
        // <div class="list-group "> 
            ...
            let list =this.props.contents.map((item,index)=>{
              return  (<div style={{display: 'inline-block'}}> 
    <div>{index}</div>
    <div  className={" list-group-item list-group-item-action "+btn_class} style={{display: 'inline-block'}} >
    <a style={{width:600 ,fontWeight:'bolder',marginRight:50,}}>{item} 
    </a>
    </div>
    ...
    <button onClick={()=>{this.props.deleteContent(index)}}  className="btn btn-danger" ><i className="fa fa-times btn-danger" ></i></button>
    </div> 
            )})
        return <div><list/></div>
    }
