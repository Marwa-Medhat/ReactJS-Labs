...
class DisplayTasks extends React.Component{
    ...
    render(){
       ...
       <a style={{width:600 ,fontWeight:'bolder',marginRight:50,}}>{this.props.contents} 
      </a><button  onClick={()=>{this.props.markContent(index)}} className="btn btn-success " style={{ marginLeft: 400,marginRight: 10 ,paddingRight:10}}><i className="fa fa-check "></i></button> 
