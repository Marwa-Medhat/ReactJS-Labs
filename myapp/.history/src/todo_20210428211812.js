...
class DisplayTask extends React.Component{
    ...
    <button  className="btn btn-success" style={{ marginLeft: 400 ,paddingRight:10}}><i className="fa fa-check "></i></button> 
    <button className="btn btn-danger"style={{ marginRight: 400}} ><i className="fa fa-times btn-danger" ></i></button></a>
