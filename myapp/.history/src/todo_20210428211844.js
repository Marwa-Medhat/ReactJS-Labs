...
class DisplayTask extends React.Component{
    ...
    <button  className="btn btn-success" style={{ marginLeft: 400,marginRight: 100 ,paddingRight:10}}><i className="fa fa-check "></i></button> 
    <button className="btn btn-danger"style={{ }} ><i className="fa fa-times btn-danger" ></i></button></a>
