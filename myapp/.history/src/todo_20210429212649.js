...
class Todo extends React.Component{
    ...
    render(){
        return <div>
            ...
            <DisplayTasks contents={this.state.contents} mark={this.state.mark} markContent={this.markContent}/><br/>
            </div>
    ...
    render(){
        return <div class="list-group ">          
            {this.props.contents.length > 0 ?this.props.contents.map((item,index)=>{
                return <DisplayTask contents={this.props.contents} index={index} content={item} key={item.content} mark={this.props.mark} markContent={this.props.markContent}  />
            }):"Empty"}
        </div>
    }
}
