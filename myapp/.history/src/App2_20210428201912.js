...
class DisplayTask extends React.Component{
    ...
    render(){
        return <div>
    <a href="#" class="list-group-item list-group-item-action bi bi-x-square-fill" style={{width:600, textAlign:"center"}}><i className="bi bi-x-square-fill" >{this.props.content.content}</i></a>
