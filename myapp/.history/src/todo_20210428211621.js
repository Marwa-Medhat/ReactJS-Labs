...
class DisplayTask extends React.Component{
    ...
    <button  className="btn btn-success" style={{ marginLeft: 400,padding:100}}><i className="fa fa-check "></i></button> 
    <button className="btn btn-danger" style={{padding:100}}><i className="fa fa-times btn-danger" ></i></button></a>
