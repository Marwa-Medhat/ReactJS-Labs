...
//     }
    ...
    <a  style={{backgroundColor: "lightblue"}} href="#" class="list-group-item list-group-item-action " style={{width:600 ,fontWeight:'bolder',marginRight:50,}}>{this.props.content.content} 
