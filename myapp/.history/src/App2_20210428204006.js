...
class DisplayTask extends React.Component{
    ...
    render(){
        return <div>
    <a href="#" class="list-group-item list-group-item-action " style={{width:600, textAlign:"center"}}>{this.props.content.content}</a>
        <button><i className="fa fa-times btn-danger" ></i></button>
    </div>
    }
}
export default Todo;
