...
class AddTask extends React.Component{
    ...
    render(){
        return <div>
           ...
           <br/> <button onClick={this.addContent} className="btn btn-primary " style={{ margin: 50,}}>Add</button>
        </div>
    }
}
...
class DisplayTask extends React.Component{
    ...
    render(){
        return <div>
    <a href="#" class="list-group-item list-group-item-action " style={{width:600, textAlign:"center"}}><i className="fa fa-times" >{this.props.content.content}</i></a>
