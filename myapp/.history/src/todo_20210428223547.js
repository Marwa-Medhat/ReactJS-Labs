...
//     }
    ...
    render(){
        ...
        return <div style={{backgroundColor: "lightblue"}} className={" list-group-item list-group-item-action "+btn_class} >
      <a  href="#" style={{width:600 ,fontWeight:'bolder',marginRight:50,}}>{this.props.content.content} 
